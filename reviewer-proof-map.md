...
| First public artifact | [Making Competence Inspectable](essays/making-competence-inspectable.md) |
...
|---|---|
| SOC / MDR analyst | Analyst-facing thinking about evidence, triage, false positives, escalation, and documentation. |
| Security analyst | Risk framing, source-backed reasoning, and role-specific proof strategy. |
| Detection analyst | Emphasis on detection logic, validation, and inspectable evidence. |
| AI security / trust architecture | Early framework layer for policy-bound tools, AI-assisted SecOps guardrails, and auditability. |
| Technical communicator | Clear transformation of complex labor-market and security concepts into readable public artifacts. |

## Scope boundaries

This repository is a public field-notes archive. It does not claim:

- production SOC employment,
- ownership of enterprise incident response,
- production SIEM administration,
- formal vulnerability-management program ownership,
- professional red-team experience,
- or direct proof that portfolio work guarantees hiring.

The current proof is analytical and communicative. Technical execution proof remains in the dedicated security repos.
